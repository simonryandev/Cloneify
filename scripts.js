document.addEventListener('DOMContentLoaded', () => {
  ...
  const albumsData = [
    { name: 'White Noise (Sleep & Relaxation)', artist: 'Sleepy John', image: './img/album-white-noise.jpg'},
    ...
    { name: 'Escândalo Íntimo', artist: 'Luíza Sonza', image: './img/album-escandalo.jpg'}
  ];
